...
import { AttachmentType, CourseWeekType } from "@/types";
...
const AttachmentForm = ({
  ...
  const attachmentsLength = initialData?.attachments?.length as number;
      ...
      {!isEditing && (
        <>
          {initialData?.attachments.length === 0 && (
            <p className="text-xl text-slate-500 italic">No attachments yet</p>
          )}
